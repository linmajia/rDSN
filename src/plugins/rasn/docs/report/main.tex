...
no rate refund is needed here because the budget is outermost --- nothing
short-circuits after the token is acquired within its scope, unlike the
per-dependency breaker/rate interplay. Admission and rate delays are coalesced into
