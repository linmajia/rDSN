...
\texttt{model\_cost} & Resilience & Deterministic prompt-size token/cost estimator mapped onto the token bucket (tokens/minute budget) \\
...
and available budget are shown by \texttt{rasn.resilience}. A process-wide
