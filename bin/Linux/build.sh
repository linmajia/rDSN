...
#    BUILD_TESTING  YES|NO
#    BUILD_CSHARP   YES|NO
#    BUILD_PROTOBUF_CSHARP YES|NO
#    BUILD_THRIFT_CSHARP YES|NO
#    BOOST_DIR      <dir>|""
#
# CMake options:
...
#    [-DENABLE_GCOV=TRUE]
#    [-DBUILD_CSHARP=TRUE]
#    [-DBUILD_PROTOBUF_CSHARP=TRUE]
#    [-DBUILD_THRIFT_CSHARP=TRUE]
...
if [ "$BUILD_TESTING" == "NO" ]
then
    echo "BUILD_TESTING=NO"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_TESTING=OFF"
else
    echo "BUILD_TESTING=YES"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_TESTING=ON"
fi

if [ "$BUILD_CSHARP" == "YES" ]
then
    echo "BUILD_CSHARP=YES"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_CSHARP=TRUE"
else
    echo "BUILD_CSHARP=NO"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_CSHARP=FALSE"
fi

if [ "$BUILD_PROTOBUF_CSHARP" == "YES" ]
then
    echo "BUILD_PROTOBUF_CSHARP=YES"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_PROTOBUF_CSHARP=TRUE"
else
    echo "BUILD_PROTOBUF_CSHARP=NO"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_PROTOBUF_CSHARP=FALSE"
fi

if [ "$BUILD_THRIFT_CSHARP" == "YES" ]
then
    echo "BUILD_THRIFT_CSHARP=YES"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_THRIFT_CSHARP=TRUE"
else
    echo "BUILD_THRIFT_CSHARP=NO"
    CMAKE_OPTIONS="$CMAKE_OPTIONS -DBUILD_THRIFT_CSHARP=FALSE"
fi
